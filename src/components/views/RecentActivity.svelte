<script lang="ts">
  ...
  import {
    ...
    import { Ecosystem } from "carbon-pictograms-svelte";
  ...
  <Row>
    <Tile light style="margin-bottom:1%;width:100%">
     ...
     <Tile style="margin-top:2px;cursor:pointer" on:click={()=>{onclick(note)}}>
      <p style="float:left;"><span style="color:orange;"><CommentUser textOnly pubkey={note.pubkey} /></span>: {kindToVerb(note)}</p>
